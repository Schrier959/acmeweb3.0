...
public class StatusController {
    ...
    public ServerStatus displayRequestInfo(@RequestParam(value = "name", defaultValue = "Anonymous") String name,
                                           @RequestParam List<String> hello) {
        Logger logger = LoggerFactory.getLogger("StuffImInterestedIn");
        logger.info("Details are " + hello);
